...
<div class="ap" id="ap">
  ...
  <div class="ap__inner">
      ...
      <div class="ap__item ap__item--track">
        <div class="ap__track_profile">
          <div class="tuh">
            <img  class="ap__icon_profile" src="http://los40es00.epimg.net/los40/imagenes/2017/01/17/album/1484675309_894438_1484675936_album_normal.jpg" alt="">
          </div>
        </div>
        <div class="track">
...
export default {
  ...
  created(){
    EventBus.$on('ADD_MUSIC_PLAYER',function(data){
      let  url =`${SERVER_URI}/api/files/music/${data.tracks[0].url}` || 0;
      console.log("hola como esta",url)
      
 var iconImage = 'http://funkyimg.com/i/21pX5.png';
  AudioPlayer().destroy()
    AudioPlayer().init({
  playList: [
    {'icon': iconImage, 'title': 'Hitman', 'file': url}
  ]
});
     console.log("hola")
